...
{
   public class BlockingIntcodeComputer
   {
      private bool _complete;

      public BlockingIntcodeComputer(int[] intcode, params int[] initialInp)
      {
      ...
      public event Action<int> OutputProduced;
